                ...
                <div className="relative w-full h-3 bg-[#F2E9E4] rounded-full mb-12">
                  <div
                    ...
                    style={{
                      width: `${progress}%`,
                      background:
                        "linear-gradient(90deg, #F7B267 0%, #B4E9D6 100%)",
                    }}
                  />
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {Object.entries(
                        currentQuestion[currentQuestionIndex].options
                      ).map(([key, value], idx) => {
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {badges.map((badge, idx) => (
                        <Badge
                          key={badge}
                          variant="secondary"
                          className={`text-lg px-4 py-2 rounded-full border-2 font-semibold shadow-sm ${
                            [
